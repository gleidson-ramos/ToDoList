...
Aplicação web simples para criação, gerenciamento e conclusão de tarefas, desenvolvida utilizando HTML, CSS e Vue.js.
...
O projeto foi utilizado como exercício introdutório para demonstrar a construção de uma aplicação web utilizando Vue.js.
